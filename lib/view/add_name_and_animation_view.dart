...
import '../provider/create_memory_provider.dart';
import '../routes.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CommonTextField(
                        ...
                        onChange: (value) {
                          widget.provider.title = value ?? '';
                        },
                      ),
                      SizedBox(height: 18.h),
                      Text('receiver_name'.tr()).regular(
                        fontSize: 16.sp,
                        color: ColorConstants.color363636,
                      ),
                      SizedBox(height: 7.h),
                      CommonTextField(
                        ...
                        textAlign: TextAlign.start,
                        onChange: (value) {
                          widget.provider.receiverName = value ?? '';
                        },
                      ),
                      SizedBox(height: 18.h),
                      Text('animation'.tr()).regular(
                        fontSize: 16.sp,
                        color: ColorConstants.color363636,
                      ),
                      SizedBox(height: 7.h),
